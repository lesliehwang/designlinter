...
function Filter(props) {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { className: "flex-container filter" },
            React.createElement("div", { className: "instructions" }, "Select Linter: "),
            React.createElement("div", { className: "checkbox-element" },
                React.createElement("input", { type: "checkbox", checked: allCheckbox, onChange: handleChangeAll }),
                React.createElement("label", null, " ALL")),
            React.createElement("div", { className: "checkbox-element" },
                React.createElement("input", { type: "checkbox", checked: colorCheckbox, onChange: handleChangeColor }),
                React.createElement("label", null, " Color")),
            React.createElement("div", { className: "checkbox-element" },
                React.createElement("input", { type: "checkbox", checked: strokeCheckbox, onChange: handleChangeStroke }),
                React.createElement("label", null, " Stroke")),
            React.createElement("div", { className: "checkbox-element" },
                React.createElement("input", { type: "checkbox", checked: typeCheckbox, onChange: handleChangeType }),
                React.createElement("label", null, " Typography")),
            React.createElement("div", { className: "checkbox-element" },
                React.createElement("input", { type: "checkbox", checked: effectsCheckbox, onChange: handleChangeEffects }),
                React.createElement("label", null, " Effects")),
            React.createElement("div", { className: "checkbox-element" },
                React.createElement("input", { type: "checkbox", checked: radiusCheckbox, onChange: handleChangeRadius }),
        ...
        React.createElement("div", { className: "footer sticky-footer" },
            React.createElement(TotalErrorCount, { errorArray: bulkErrorListToPass }))));
}
