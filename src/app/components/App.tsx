...
const App = ({}) => {
  ...
  //updates when there is new layer selected?
  const updateSelectedList = id => {
    //updates array of selected items with new id at the end, returns new array
    ...
    //adds id if it isn't already in the array, returns array of active nodes
